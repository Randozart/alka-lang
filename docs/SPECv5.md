# Alka Language Specification v5.0

> The "Universal Solvent" for physical machine state orchestration
>
> **Version**: 5.0 (Authoritative)
> **Timestamp**: 2026-05-13
> **Supersedes**: SPEC.md, SPECv2.md, SPECv3.md, SPECv4.md
> **Status**: Living document — this file is the single source of truth
>
> **Major changes from v4**:
> - All tool names generalized to be hardware-agnostic (REFRACT→SLICE, STRIKE→POKE, etc.)
> - Merged redundant tools: MOLT→SNAP, VEIL→CLAIM, RESONATE+OSCILLATE→COORDINATE
> - New §12: Tool Chaining — pre/post states, chain graph, compiler validation
> - New §23: SPARK-First Policy — all base hardware tools are SPARK-verified
> - New §24: Implementation Roadmap — integrated from ROADMAP.md with status
> - [PLANNED] tags for unimplemented instructions (ABDUCT, SNOOP, BEAM, etc.)
...
| **Override** | A compiler flag (`--override`) that suppresses chain warnings for risky but valid sequences |
...
3. **Lookup**: Queries the `pharmacopia.json` for `description` and `risk_level`
...
### Phase 8: Tool Renames & Merges (v5.0) ✅ IN PROGRESS
...
```
Now → Phase 8 (Tool renames, merges, chain validation, SPECv5)
           │
           ▼
Next  → Phase 3 (Embed architecture: .alkar, UNPACK)
           │
           ▼
Week 2 → Phase 4 (CLI overhaul) + Phase 5 (Declarative syntax)
           │
           ▼
Week 3 → Phase 6 (Proof automation)
           │
           ▼
Week 4 → Phase 7 (Install target)
           │
           ▼
...
*End of SPECv5. Written 2026-05-13. Single source of truth for Alka v5.0.*
